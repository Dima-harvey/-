// разделяй и властвуй.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
...
int main() {
	...
	cin >> Days;
	int *stocks = new int[Days - 1];
	int *cost_stocks = new int[Days];
	int counter = 0;
	int status = true;
